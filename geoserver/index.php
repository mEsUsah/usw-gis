...
<body class="w-full max-w-4xl mx-auto flex flex-col h-screen">
    <header class="flex flex-row gap-4 lg:gap-8 items-center">
        ...
        <div class="pr-2">
            ...
            <p class="text-md lg:text-xl">GeoServer</p>
        </div>
    </header>
    <nav class="m-4 lg:my-4 lg:mx-8">
        <a href="/" class="text-[#DE0832] hover:underline">Home</a> / GeoServer
    </nav>
    <main class="m-4 lg:m-8 flex-grow">
        <h2 class="text-lg lg:text-2xl font-medium">Maps</h2>
        <p class=" mb-4">Result from coursework during my studies at the University of South Wales 2025/2026</p>
        <ul>
            <?php
