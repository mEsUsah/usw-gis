 ...
 *  L.Control.WMSLegend is used to add a WMS Legend to the map
    From: https://github.com/kartoza/leaflet-wms-legend
 */
...
L.Control.WMSLegend = L.Control.extend({
    ...
    onAdd: function () {
        ...
        this.button = L.DomUtil.create('button', 'text-black font-medium', this.container);
        this.button.textContent = 'Legend';
    ...
    _click: function (e) {
        ...
        if (style.display === 'none') {
            ...
            this.container.style.height = '32.22px';
            this.container.style.width = '64.44px';
